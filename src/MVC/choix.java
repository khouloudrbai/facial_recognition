...
public class choix extends JFrame {
	int x=70, y=70;
	Icon b1i=Fonctionalite.ResizeImage("Images/policeavatar.png",x,y);
	JButton b1=new JButton(b1i);
	Icon b2i=Fonctionalite.ResizeImage("Images/chercher.jpg",x,y);
	JButton b2=new JButton(b2i);
	Icon b3i=Fonctionalite.ResizeImage("Images/citoyen.jpg",x,y);
